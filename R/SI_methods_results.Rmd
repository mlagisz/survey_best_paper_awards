...
### Figure A.   
*Project workflow. When an award was linked to a journal which had more than one SCImago Subject Area (SA) assigned, we used award description to choose the most fitting Subject Area for the award (i.e., we excluded copies of the award record from the less relevant Subject Area – see the bottom right corner of the workflow)*.   
...
Load author contributorship data set:    
...
### Code for the main Figure 1A.  
- Screening effort: count numbers of journals screened to get 10 shortlisted awards (main text figure - not shown in SI).   
...
### Code for the main Figure 1B.  
- Counts of incuded awards with and without award description (main text figure - not shown in SI).       
...
### Code for the main Figure 1C.  
- Plot of award description lengths - overall (main text figure - not shown in SI).         
...
### Code for the main Figure 1D.    
- award age overall distribution  (main text figure - not shown in SI).       
...
### Code for the main Figure 1.  
- Combine 4 panels and save (main text figure - not shown in SI).      
...
### Code for the main Figure 2A.  
- Awarding bodies (main text figure - not shown in SI).        
...
### Code for the main Figure 2B.  
- target awardee career stages (main text figure - not shown in SI).       
...
### Code for the main Figure 2.    
- combine 2 panels and save (main text figure - not shown in SI).      
...
### Code for the main Figure 3A.   
- Summary plots of key award characteristics  (main text figure - not shown in SI).   
...
### Code for the main Figure 4A.   
- frequencies of specific words - all mentions in award descriptions (main text figure - not shown in SI).         
...
### Code for the main Figure 4B.  
- frequencies of specific words - first mentions in award descriptions (main text figure - not shown in SI).      
...
### Code for the main Figure 5A.   
- plot of gender counts by decade (main text figure - not shown in SI).           
...
### Code for the main Figure 5B.   
- plot of gender proportions by decade (main text figure - not shown in SI).      
...
### Code for the main Figure 5C.    
- plot of counts of top 10 country affiliations by decade (main text figure - not shown in SI).   
...
### Code for the main Figure 5D.    
- proportions of top 10 affiliation countries by decade (main text figure - not shown in SI).       
...
figure5 <- figure5A / figure5B / figure5C / figure5D + 
  ...
  plot_annotation(tag_levels = "A")
#ggsave(plot = figure5, here("plots", "Fig5ABCD_gender_countries_v2.png"), width = 18, height = 14, units = "cm", dpi = "retina", scale = 1.2)
#ggsave(plot = figure5, here("plots", "Fig5ABCD_gender_countries_v2.pdf"), width = 18, height = 14, units = "cm", scale = 1.2)
```
...
### Figure F2.   
*Map of counts of individual awardees by country of first affiliation. Map base source:   https://search.r-project.org/CRAN/refmans/maps/html/world.html  [R Package "maps" version 3.4.2]. Shapefile: Natural Earth  https://www.naturalearthdata.com/about/terms-of-use/*.     
...
### Figure G2.   
*Map of counts of individual awardees by country of first affiliation split by decade.  Map base source:   https://search.r-project.org/CRAN/refmans/maps/html/world.html  [R Package "maps" version 3.4.2]. Shapefile: Natural Earth  https://www.naturalearthdata.com/about/terms-of-use/*.      
...
### Code for the main Figure 6A.    
- mentions of cash awards (main text figure - not shown in SI).      
...
### Code for the main Figure 6B.   
- disclosed values of cash awards (main text figure - not shown in SI).      
...
figure6 <- figure6A / figure6B +
  ...
  plot_annotation(tag_levels = "A")
#ggsave(plot = figure6, here("plots", "Fig6AB_perks_v2.png"), width = 18, height = 8, units = "cm", dpi = "retina", scale = 1.2)
#ggsave(plot = figure6, here("plots", "Fig6AB_perks_v2.pdf"), width = 18, height = 8, units = "cm", scale = 1.2)
```
...
### Code for the main Figure 7A.   
- Individual winners data - presence of a personal profile (main text figure - not shown in SI).       
...
### Code for the main Figure 7B.    
- Individual winners data - presence of a personal photo (main text figure - not shown in SI).      
...
figure7 <- figure7A / figure7B +
  plot_layout(ncol = 2, nrow = 1) +
  plot_annotation(tag_levels = "A")
#ggsave(plot = figure7, here("plots", "Fig7AB_perks_v2.png"), width = 18, height = 8, units = "cm", dpi = "retina", scale = 1.2)
#ggsave(plot = figure7, here("plots", "Fig7AB_perks_v2.pdf"), width = 18, height = 8, units = "cm", scale = 1.2)
```
...
Logistic plot of assessor transparency versus award age:   
...
#ggsave(here("plots", "Fig_contibutorship.png"), width = 18.6, height = 16, units = "cm", dpi = "retina", scale = 1.2)
#ggsave(here("plots", "Fig_contibutorship.pdf"), width = 18.6, height = 16, units = "cm", scale = 1.2)
```
```
